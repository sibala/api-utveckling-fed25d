...
- If time allows, do lab5 that was given before the summer holidays, to practive objects in JS.
...
- [Keyword this](https://www.w3schools.com/js/js_this.asp)
...
- [Object classes](https://www.w3schools.com/js/js_classes.asp)
